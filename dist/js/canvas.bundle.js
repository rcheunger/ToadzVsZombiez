...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.p + "194aaf87bb5ede64d1cdcb7cf5821a2e.png");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (__webpack_require__.p + "384c59c80695d314bf147b403cf715bd.png");
...
/* harmony import */ var _img_zombieSprite_png__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../img/zombieSprite.png */ "./src/img/zombieSprite.png");
/* harmony import */ var _img_zombieSpriteRight_png__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../img/zombieSpriteRight.png */ "./src/img/zombieSpriteRight.png");
...
var Player = /*#__PURE__*/function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(Player, [{
    ...
    value: function update() {
      this.frames++;
      if (this.frames > 28 && (this.currentSprite === this.sprites.stand.right || this.currentSprite === this.sprites.stand.left)) this.frames = 0;else if (this.frames > 59 && (this.currentSprite === this.sprites.run.right || this.currentSprite === this.sprites.run.left)) this.frames = 0;else if (this.currentSprite === this.sprites.jump.right || this.currentSprite === this.sprites.jump.left) this.frames = 0;
      this.draw();
...
var Zombie = /*#__PURE__*/function () {
  function Zombie(_ref3) {
    ...
    this.sprites = {
      walk: {
        right: Object(_utils_js__WEBPACK_IMPORTED_MODULE_4__["createImage"])(_img_zombieSpriteRight_png__WEBPACK_IMPORTED_MODULE_18__["default"]),
        left: Object(_utils_js__WEBPACK_IMPORTED_MODULE_4__["createImage"])(_img_zombieSprite_png__WEBPACK_IMPORTED_MODULE_17__["default"])
      }
    };
...
/*!*************************!*\
  !*** ./src/js/utils.js ***!
  \*************************/
/*! exports provided: createImage, createImageAsync, isOnTopOfPlatform, collisionTop, isOnTopOfPlatformCircle, hitTopOfPlatform, hitBottomOfPlatform, hitSideOfPlatform */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
